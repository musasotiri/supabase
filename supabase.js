    ...
    var e,
      ...
      r = {
              ...
              return (
                ...
                (c = function* () {
                  try {
                    ...
                    let d,
                      f = (
                        null !== (r = l.headers.get("Content-Type")) &&
                        void 0 !== r
                          ? r
                          : "text/plain"
                      )
        ...
        165: (e, t, r) => {
          ...
          r.r(t),
            r.d(t, {
              AuthApiError: () => u,
              AuthError: () => c,
              AuthImplicitGrantRedirectError: () => y,
              AuthInvalidCredentialsError: () => v,
              AuthRetryableFetchError: () => m,
              AuthSessionMissingError: () => p,
              AuthUnknownError: () => d,
              CustomAuthError: () => f,
              GoTrueAdminApi: () => S,
              GoTrueClient: () => k,
          ...
          function _(e, t, r, s) {
            ...
            return g(this, void 0, void 0, function* () {
              const o =
                null !== (n = null == s ? void 0 : s.headers) && void 0 !== n
                  ? n
                  : {};
              (null == s ? void 0 : s.jwt) &&
              ...
              const h = Object.keys(a).length
                  ? "?" + new URLSearchParams(a).toString()
                  : "",
                c = yield (function (e, t, r, s, n, i) {
                  return g(this, void 0, void 0, function* () {
                            ...
                            g(void 0, void 0, void 0, function* () {
                              ...
                              "function" == typeof r.json
                                ? [502, 503, 504].includes(e.status)
                                  ? t(new m(b(e), e.status))
                                  : e
                                      .json()
                                      .then((r) => {
                                        t(new u(b(r), e.status || 500));
                                      })
                                      .catch((e) => {
                                        t(new d(b(e), e));
                                      })
          ...
          class S {
            constructor({ url: e = "", headers: t = {}, fetch: r }) {
              (this.url = e), (this.headers = t), (this.fetch = o(r));
            }
            signOut(e) {
              return O(this, void 0, void 0, function* () {
                try {
                  return (
                    yield _(this.fetch, "POST", `${this.url}/logout`, {
            ...
            inviteUserByEmail(e, t = {}) {
              return O(this, void 0, void 0, function* () {
                try {
                  return yield _(this.fetch, "POST", `${this.url}/invite`, {
                  ...
                  if (l(e)) return { data: { user: null }, error: e };
                  throw e;
                }
              });
            }
              ...
              return O(this, void 0, void 0, function* () {
                try {
                  return yield _(
                    ...
                    { body: e, headers: this.headers, xform: E }
                  );
                } catch (e) {
                  if (l(e)) return { data: { user: null }, error: e };
                  throw e;
            ...
            listUsers() {
              return O(this, void 0, void 0, function* () {
                try {
                  ...
                  if (l(e)) return { data: { users: [] }, error: e };
                  throw e;
                }
              });
            }
              ...
              return O(this, void 0, void 0, function* () {
                try {
                  return yield _(
                    ...
                    "PUT",
                    `${this.url}/admin/users/${e}`,
                    { body: t, headers: this.headers, xform: E }
                  );
                } catch (e) {
                  if (l(e)) return { data: { user: null }, error: e };
                  throw e;
          ...
          const x = {
            ...
            headers: { "X-Client-Info": "gotrue-js/2.0.1" },
          };
          class k {
            constructor(e) {
              ...
              return P(this, void 0, void 0, function* () {
                try {
                  ...
                  if ((yield this._removeSession(), "email" in e)) {
                    ...
                    t = yield _(this.fetch, "POST", `${this.url}/signup`, {
                      headers: this.headers,
                  ...
                  return (
                    ...
                    { data: { user: i, session: n }, error: null }
                  );
                } catch (e) {
                  if (l(e))
                      ...
                      { error: i } = yield _(
                        ...
                        `${this.url}/otp`,
                        {
                          ...
                          body: {
                            ...
                            create_user:
                              null ===
                                (r = null == n ? void 0 : n.shouldCreateUser) ||
                              void 0 === r ||
                              r,
                            gotrue_meta_security: {
                              captcha_token:
                      ...
                      { error: i } = yield _(
                        ...
                        `${this.url}/otp`,
                        {
                          ...
                          body: {
                            ...
                            create_user:
                              null ===
                                (n = null == r ? void 0 : r.shouldCreateUser) ||
                              void 0 === n ||
                              n,
                            gotrue_meta_security: {
                              captcha_token:
            ...
            getUser(e) {
              ...
              return P(this, void 0, void 0, function* () {
                try {
                  ...
                  return yield _(this.fetch, "GET", `${this.url}/user`, {
                    headers: this.headers,
                    jwt: e,
                    xform: E,
                  });
            ...
            setSession(e) {
              return P(this, void 0, void 0, function* () {
                try {
                  ...
                  if (s) {
                    if (!e.refresh_token) throw new p();
                    const { data: t, error: r } =
                      yield this._refreshAccessToken(e.refresh_token);
                    if (r)
                    ...
                    const { data: s, error: i } = yield this.getUser(
                      e.access_token
                    );
                    if (i) throw i;
                    n = {
            ...
            _getSessionFromUrl() {
              return P(this, void 0, void 0, function* () {
                try {
                  if (!n()) throw new y("No browser detected.");
                  if (!this._isImplicitGrantFlow())
                    throw new y("Not a valid implicit grant flow url.");
                  const e = i("error_description");
                  if (e) {
                    const t = i("error_code");
                    if (!t) throw new y("No error_code detected.");
                    const r = i("error");
                    if (!r) throw new y("No error detected.");
                    throw new y(e, { error: r, code: t });
                  }
                  const t = i("provider_token"),
                    r = i("provider_refresh_token"),
                    s = i("access_token");
                  if (!s) throw new y("No access_token detected.");
                  const o = i("expires_in");
                  if (!o) throw new y("No expires_in detected.");
                  const a = i("refresh_token");
                  if (!a) throw new y("No refresh_token detected.");
                  const h = i("token_type");
                  if (!h) throw new y("No token_type detected.");
            ...
            _isImplicitGrantFlow() {
              return (
                n() &&
                (Boolean(i("access_token")) || Boolean(i("error_description")))
              );
            }
            signOut() {
              var e;
            ...
            resetPasswordForEmail(e, t = {}) {
              return P(this, void 0, void 0, function* () {
                try {
                  return yield _(this.fetch, "POST", `${this.url}/recover`, {
                    body: {
                      email: e,
                    ...
                    if (this.autoRefreshToken && t.refresh_token) {
                      ...
                      if (e) {
                        if (
                          ...
                          e instanceof m && this.networkRetries < 10)
                        )
                          return (
            ...
            _callRefreshToken(e) {
              ...
              return P(this, void 0, void 0, function* () {
                ...
                try {
                  if (((this.refreshingDeferred = new h()), !e)) throw new p();
        ...
        189: (e, t, r) => {
                  ...
                  (n = function* () {
                    ...
                    if (e.ok) {
                      ...
                      if (
                        (n &&
                          this.allowEmpty &&
                          (null === (s = null == n ? void 0 : n.details) ||
                          void 0 === s
                            ? void 0
          ...
          const c = { "X-Client-Info": "postgrest-js/1.0.0" };
          class l {
            constructor(e, { headers: t = {}, schema: r, fetch: s } = {}) {
              (this.url = e),
        ...
        73: (e, t, r) => {
          ...
          class k {
                    ...
                    .receive("ok", ({ postgres_changes: t }) => {
                      ...
                      if (
                        ...
                        for (let r = 0; r < n; r++) {
                          ...
                          i.push(
                            Object.assign(Object.assign({}, n), { id: l.id })
                          );
                        }
                        return (
            ...
            _trigger(e, t, r) {
              ...
              if (r && [o, h, c, l].indexOf(i) >= 0 && r !== this._joinRef())
                return;
                ...
                (this.bindings[r] = this.bindings[r].filter((e) => {
                  ...
                  return !(
                    (null === (s = e.type) || void 0 === s
                      ? void 0
                      : s.toLocaleLowerCase()) === r && k.isEqual(e.filter, t)
                  );
                })),
                this
              );
          ...
          class A {
            ...
            removeChannel(e) {
              return e
                .unsubscribe()
                .then(
                  (e) => (0 === this.channels.length && this.disconnect(), e)
                );
            }
            removeAllChannels() {
              return Promise.all(
                this.channels.map((e) => e.unsubscribe())
              ).then((e) => (this.disconnect(), e));
            }
            log(e, t, r) {
              this.logger(e, t, r);
            }
        ...
        752: (e, t, r) => {
          ...
          class g {
            ...
            createSignedUrl(e, t, r) {
              return v(this, void 0, void 0, function* () {
                try {
                  ...
                  return (
                    (n = {
                      signedUrl: encodeURI(`${this.url}${n.signedURL}${i}`),
                    }),
                    { data: n, error: null }
                  );
                } catch (e) {
              ...
              return v(this, void 0, void 0, function* () {
                try {
                  const t = this._getFinalPath(e),
                    r = yield d(this.fetch, `${this.url}/object/${t}`, {
                      headers: this.headers,
                      noResolveJson: !0,
                    });
            ...
            getPublicUrl(e, t) {
              ...
              return {
                data: {
                  publicUrl: encodeURI(`${this.url}/object/public/${r}${s}`),
                },
              };
            }
            remove(e) {
          ...
          const b = { "X-Client-Info": "storage-js/2.0.0" };
